$(function () {
    ...
    ylyuan.on("mousedown",function(e){
                 $(document).on("mousemove",".yinliang-pro",function(e){
                     if(e.offsetX>$(".yinliang-pro").width() || e.offsetX<0){
                         return;
                     }
                  ylqj.css("width",e.offsetX - ylyuan.width())
                  audio.volume = e.offsetX/ylW
              })
           })
    ...
    //拖动演唱进度条
    timryuan.on("mousedown",function(e){
        $(document).on("mousemove",function(e){
            if(e.offsetX>$(".time-pro").width() || e.offsetX<0){
                return;
            }
            timrqj.css("width",e.offsetX - timryuan.width())
            audio.currentTime = e.offsetX/timeW
        })
    })
    $(document).on("mouseup",function(){
        $(document).off("mousemove")
